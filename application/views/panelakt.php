...
<td><a href="<?php echo base_url('/site/edytujakt/' .$r->id)?>"onclick="return confirm('Czy na pewno chcesz edytować?')"> Edytuj </a> <a href="<?php echo base_url('/site/usunakt/' .$r->id)?>" onclick="return confirm('Czy na pewno chcesz usunąć?')"> Usuń</a></td>
